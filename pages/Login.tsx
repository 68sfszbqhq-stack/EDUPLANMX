...
const Login: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // El redirect se manejará en el Router basado en el rol
            navigate('/');
        } catch (error: any) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-slate-900 mb-2">EduPlan MX</h1>
                    <p className="text-slate-600">Plataforma de Diagnóstico Socioeducativo</p>
                </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className="block w-full pl-10 pr-3 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                ...
                <div className="mt-8 text-center text-sm text-slate-500">
                    <p>© 2026 EduPlan MX - Bachillerato General Oficial</p>
                </div>
            </div>
        </div>
    );
